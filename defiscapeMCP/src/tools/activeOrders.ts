...
export function registerActiveOrders(server: McpServer) {
...
export function registerGetActiveFusionOrdersTool(server: McpServer) {
  /**
...
export function registerScanAllProfitTool(server: McpServer) {
  /**
   * 5) Tool ─ バッチ収益機会スキャナー
...
export function registerAnalyzeProfitTool(server: McpServer) {
  server.registerTool(
